...
/* @__NO_SIDE_EFFECTS__ */
function createSlot$38(ownerName) {
	const SlotClone = /* @__PURE__ */ createSlotClone$38(ownerName);
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		const childrenArray = import_react.Children.toArray(children);
		const slottable = childrenArray.find(isSlottable$38);
		if (slottable) {
...
/* @__NO_SIDE_EFFECTS__ */
function createSlotClone$38(ownerName) {
	const SlotClone = import_react.forwardRef((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		if (import_react.isValidElement(children)) {
			const childrenRef = getElementRef$39(children);
			const props2 = mergeProps$38(slotProps, children.props);
...
var SLOTTABLE_IDENTIFIER$39 = Symbol("radix.slottable");
function isSlottable$38(child) {
	return import_react.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER$39;
}
function mergeProps$38(slotProps, childProps) {
...
function getElementRef$39(element) {
...
var Primitive$36 = [
	...
	const Slot = /* @__PURE__ */ createSlot$38(`Primitive.${node}`);
...
var VisuallyHidden = import_react.forwardRef((props, forwardedRef) => {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$36.span, {
		...props,
		ref: forwardedRef,
		style: {
...
/* @__NO_SIDE_EFFECTS__ */
function createSlot$37(ownerName) {
	const SlotClone = /* @__PURE__ */ createSlotClone$37(ownerName);
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		const childrenArray = import_react.Children.toArray(children);
		const slottable = childrenArray.find(isSlottable$37);
		if (slottable) {
			const newElement = slottable.props.children;
			const newChildren = childrenArray.map((child) => {
				if (child === slottable) {
...
/* @__NO_SIDE_EFFECTS__ */
function createSlotClone$37(ownerName) {
	const SlotClone = import_react.forwardRef((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		if (import_react.isValidElement(children)) {
			const childrenRef = getElementRef$38(children);
			const props2 = mergeProps$37(slotProps, children.props);
			if (children.type !== import_react.Fragment) props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
			return import_react.cloneElement(children, props2);
		}
		return import_react.Children.count(children) > 1 ? import_react.Children.only(null) : null;
...
var SLOTTABLE_IDENTIFIER$38 = Symbol("radix.slottable");
function isSlottable$37(child) {
	return import_react.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER$38;
}
function mergeProps$37(slotProps, childProps) {
	const overrideProps = { ...childProps };
	for (const propName in childProps) {
		const slotPropValue = slotProps[propName];
		const childPropValue = childProps[propName];
...
function getElementRef$38(element) {
	let getter = Object.getOwnPropertyDescriptor(element.props, "ref")?.get;
	let mayWarn = getter && "isReactWarning" in getter && getter.isReactWarning;
	if (mayWarn) return element.ref;
	getter = Object.getOwnPropertyDescriptor(element, "ref")?.get;
...
function createCollection(name) {
	...
	const CollectionSlotImpl = /* @__PURE__ */ createSlot$37(COLLECTION_SLOT_NAME);
	...
	const CollectionItemSlotImpl = /* @__PURE__ */ createSlot$37(ITEM_SLOT_NAME);
...
/* @__NO_SIDE_EFFECTS__ */
function createSlot$36(ownerName) {
	const SlotClone = /* @__PURE__ */ createSlotClone$36(ownerName);
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		const childrenArray = import_react.Children.toArray(children);
		const slottable = childrenArray.find(isSlottable$36);
		if (slottable) {
			const newElement = slottable.props.children;
			const newChildren = childrenArray.map((child) => {
				if (child === slottable) {
...
/* @__NO_SIDE_EFFECTS__ */
function createSlotClone$36(ownerName) {
	const SlotClone = import_react.forwardRef((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		if (import_react.isValidElement(children)) {
			const childrenRef = getElementRef$37(children);
			const props2 = mergeProps$36(slotProps, children.props);
			if (children.type !== import_react.Fragment) props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
			return import_react.cloneElement(children, props2);
		}
		return import_react.Children.count(children) > 1 ? import_react.Children.only(null) : null;
...
var SLOTTABLE_IDENTIFIER$37 = Symbol("radix.slottable");
function isSlottable$36(child) {
	return import_react.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER$37;
}
function mergeProps$36(slotProps, childProps) {
	const overrideProps = { ...childProps };
	for (const propName in childProps) {
		const slotPropValue = slotProps[propName];
		const childPropValue = childProps[propName];
...
function getElementRef$37(element) {
	let getter = Object.getOwnPropertyDescriptor(element.props, "ref")?.get;
	let mayWarn = getter && "isReactWarning" in getter && getter.isReactWarning;
	if (mayWarn) return element.ref;
	getter = Object.getOwnPropertyDescriptor(element, "ref")?.get;
...
var Primitive$35 = [
	...
	const Slot = /* @__PURE__ */ createSlot$36(`Primitive.${node}`);
	const Node = import_react.forwardRef((props, forwardedRef) => {
		const { asChild, ...primitiveProps } = props;
		const Comp = asChild ? Slot : node;
		if (typeof window !== "undefined") window[Symbol.for("radix-ui")] = true;
...
/* @__NO_SIDE_EFFECTS__ */
function createSlot$35(ownerName) {
	const SlotClone = /* @__PURE__ */ createSlotClone$35(ownerName);
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		const childrenArray = import_react.Children.toArray(children);
		const slottable = childrenArray.find(isSlottable$35);
		if (slottable) {
			const newElement = slottable.props.children;
			const newChildren = childrenArray.map((child) => {
				if (child === slottable) {
...
/* @__NO_SIDE_EFFECTS__ */
function createSlotClone$35(ownerName) {
	const SlotClone = import_react.forwardRef((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		if (import_react.isValidElement(children)) {
			const childrenRef = getElementRef$36(children);
			const props2 = mergeProps$35(slotProps, children.props);
			if (children.type !== import_react.Fragment) props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
			return import_react.cloneElement(children, props2);
		}
		return import_react.Children.count(children) > 1 ? import_react.Children.only(null) : null;
...
var SLOTTABLE_IDENTIFIER$36 = Symbol("radix.slottable");
function isSlottable$35(child) {
	return import_react.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER$36;
}
function mergeProps$35(slotProps, childProps) {
	const overrideProps = { ...childProps };
	for (const propName in childProps) {
		const slotPropValue = slotProps[propName];
		const childPropValue = childProps[propName];
...
function getElementRef$36(element) {
	let getter = Object.getOwnPropertyDescriptor(element.props, "ref")?.get;
	let mayWarn = getter && "isReactWarning" in getter && getter.isReactWarning;
	if (mayWarn) return element.ref;
	getter = Object.getOwnPropertyDescriptor(element, "ref")?.get;
...
var Primitive$34 = [
	...
	const Slot = /* @__PURE__ */ createSlot$35(`Primitive.${node}`);
	const Node = import_react.forwardRef((props, forwardedRef) => {
		const { asChild, ...primitiveProps } = props;
		const Comp = asChild ? Slot : node;
		if (typeof window !== "undefined") window[Symbol.for("radix-ui")] = true;
...
var Presence = (props) => {
	...
	const ref = useComposedRefs(presence.ref, getElementRef$35(child));
...
function getElementRef$35(element) {
	let getter = Object.getOwnPropertyDescriptor(element.props, "ref")?.get;
	let mayWarn = getter && "isReactWarning" in getter && getter.isReactWarning;
	if (mayWarn) return element.ref;
	getter = Object.getOwnPropertyDescriptor(element, "ref")?.get;
...
var Collapsible = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CollapsibleProvider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$34.div, {
...
var CollapsibleTrigger = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$34.button, {
		type: "button",
...
var CollapsibleContentImpl = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$34.div, {
		"data-state": getState$6(context.open),
		"data-disabled": context.disabled ? "" : void 0,
...
var AccordionImpl = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AccordionImplProvider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection$8.Slot, {
			scope: __scopeAccordion,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$35.div, {
				...accordionProps,
...
var AccordionHeader = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$35.h3, {
		"data-orientation": accordionContext.orientation,
...
/* @__NO_SIDE_EFFECTS__ */
function createSlot$34(ownerName) {
	const SlotClone = /* @__PURE__ */ createSlotClone$34(ownerName);
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		const childrenArray = import_react.Children.toArray(children);
		const slottable = childrenArray.find(isSlottable$34);
		if (slottable) {
			const newElement = slottable.props.children;
			const newChildren = childrenArray.map((child) => {
				if (child === slottable) {
...
/* @__NO_SIDE_EFFECTS__ */
function createSlotClone$34(ownerName) {
	const SlotClone = import_react.forwardRef((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		if (import_react.isValidElement(children)) {
			const childrenRef = getElementRef$34(children);
			const props2 = mergeProps$34(slotProps, children.props);
			if (children.type !== import_react.Fragment) props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
			return import_react.cloneElement(children, props2);
		}
		return import_react.Children.count(children) > 1 ? import_react.Children.only(null) : null;
...
var SLOTTABLE_IDENTIFIER$35 = Symbol("radix.slottable");
function isSlottable$34(child) {
	return import_react.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER$35;
}
function mergeProps$34(slotProps, childProps) {
	const overrideProps = { ...childProps };
	for (const propName in childProps) {
		const slotPropValue = slotProps[propName];
		const childPropValue = childProps[propName];
...
function getElementRef$34(element) {
	let getter = Object.getOwnPropertyDescriptor(element.props, "ref")?.get;
	let mayWarn = getter && "isReactWarning" in getter && getter.isReactWarning;
	if (mayWarn) return element.ref;
	getter = Object.getOwnPropertyDescriptor(element, "ref")?.get;
...
var Primitive$33 = [
	...
	const Slot = /* @__PURE__ */ createSlot$34(`Primitive.${node}`);
	const Node = import_react.forwardRef((props, forwardedRef) => {
		const { asChild, ...primitiveProps } = props;
		const Comp = asChild ? Slot : node;
		if (typeof window !== "undefined") window[Symbol.for("radix-ui")] = true;
...
var DismissableLayer = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$33.div, {
		...layerProps,
		ref: composedRefs,
		style: {
...
function createSlot$33(ownerName) {
	const SlotClone = /* @__PURE__ */ createSlotClone$33(ownerName);
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		const childrenArray = import_react.Children.toArray(children);
		const slottable = childrenArray.find(isSlottable$33);
		if (slottable) {
			const newElement = slottable.props.children;
			const newChildren = childrenArray.map((child) => {
				if (child === slottable) {
...
/* @__NO_SIDE_EFFECTS__ */
function createSlotClone$33(ownerName) {
	const SlotClone = import_react.forwardRef((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		if (import_react.isValidElement(children)) {
			const childrenRef = getElementRef$33(children);
			const props2 = mergeProps$33(slotProps, children.props);
			if (children.type !== import_react.Fragment) props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
			return import_react.cloneElement(children, props2);
		}
		return import_react.Children.count(children) > 1 ? import_react.Children.only(null) : null;
...
var SLOTTABLE_IDENTIFIER$34 = Symbol("radix.slottable");
function isSlottable$33(child) {
	return import_react.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER$34;
}
...
var FocusScope = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$32.div, {
		tabIndex: -1,
		...scopeProps,
		ref: composedRefs,
...
var SLOTTABLE_IDENTIFIER$33 = Symbol("radix.slottable");
...
var Primitive$31 = [
	...
	const Slot = /* @__PURE__ */ createSlot$32(`Primitive.${node}`);
	const Node = import_react.forwardRef((props, forwardedRef) => {
		const { asChild, ...primitiveProps } = props;
		const Comp = asChild ? Slot : node;
		if (typeof window !== "undefined") window[Symbol.for("radix-ui")] = true;
...
var Portal$6 = import_react.forwardRef((props, forwardedRef) => {
	...
	return container ? import_react_dom.createPortal(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$31.div, {
		...portalProps,
		ref: forwardedRef
	}), container) : null;
});
...
function createSlot$31(ownerName) {
	const SlotClone = /* @__PURE__ */ createSlotClone$31(ownerName);
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		const childrenArray = import_react.Children.toArray(children);
		const slottable = childrenArray.find(isSlottable$31);
		if (slottable) {
			const newElement = slottable.props.children;
			const newChildren = childrenArray.map((child) => {
				if (child === slottable) {
...
/* @__NO_SIDE_EFFECTS__ */
function createSlotClone$31(ownerName) {
	const SlotClone = import_react.forwardRef((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		if (import_react.isValidElement(children)) {
			const childrenRef = getElementRef$31(children);
			const props2 = mergeProps$31(slotProps, children.props);
			if (children.type !== import_react.Fragment) props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
			return import_react.cloneElement(children, props2);
		}
		return import_react.Children.count(children) > 1 ? import_react.Children.only(null) : null;
...
var SLOTTABLE_IDENTIFIER$32 = Symbol("radix.slottable");
...
var Slot$4 = /* @__PURE__ */ createSlot$31("DialogOverlay.RemoveScroll");
...
var DialogTitle = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$30.h2, {
		id: context.titleId,
		...titleProps,
		ref: forwardedRef
	});
...
var DialogDescription = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$30.p, {
...
var SLOTTABLE_IDENTIFIER$31 = Symbol("radix.slottable");
/* @__NO_SIDE_EFFECTS__ */
function createSlottable$2(ownerName) {
	...
	Slottable2.__radixId = SLOTTABLE_IDENTIFIER$31;
	return Slottable2;
}
//#endregion
...
function createSlot$30(ownerName) {
	const SlotClone = /* @__PURE__ */ createSlotClone$30(ownerName);
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		const childrenArray = import_react.Children.toArray(children);
		const slottable = childrenArray.find(isSlottable$30);
		if (slottable) {
			const newElement = slottable.props.children;
			const newChildren = childrenArray.map((child) => {
				if (child === slottable) {
...
/* @__NO_SIDE_EFFECTS__ */
function createSlotClone$30(ownerName) {
	const SlotClone = import_react.forwardRef((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		if (import_react.isValidElement(children)) {
			const childrenRef = getElementRef$30(children);
			const props2 = mergeProps$30(slotProps, children.props);
			if (children.type !== import_react.Fragment) props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
			return import_react.cloneElement(children, props2);
		}
		return import_react.Children.count(children) > 1 ? import_react.Children.only(null) : null;
...
var SLOTTABLE_IDENTIFIER$30 = Symbol("radix.slottable");
...
function createSlot$29(ownerName) {
	const SlotClone = /* @__PURE__ */ createSlotClone$29(ownerName);
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		const childrenArray = import_react.Children.toArray(children);
		const slottable = childrenArray.find(isSlottable$29);
		if (slottable) {
			const newElement = slottable.props.children;
			const newChildren = childrenArray.map((child) => {
				if (child === slottable) {
...
/* @__NO_SIDE_EFFECTS__ */
function createSlotClone$29(ownerName) {
	const SlotClone = import_react.forwardRef((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		if (import_react.isValidElement(children)) {
			const childrenRef = getElementRef$29(children);
			const props2 = mergeProps$29(slotProps, children.props);
			if (children.type !== import_react.Fragment) props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
			return import_react.cloneElement(children, props2);
		}
		return import_react.Children.count(children) > 1 ? import_react.Children.only(null) : null;
...
var SLOTTABLE_IDENTIFIER$29 = Symbol("radix.slottable");
...
function createSlot$28(ownerName) {
	const SlotClone = /* @__PURE__ */ createSlotClone$28(ownerName);
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		const childrenArray = import_react.Children.toArray(children);
		const slottable = childrenArray.find(isSlottable$28);
		if (slottable) {
			const newElement = slottable.props.children;
			const newChildren = childrenArray.map((child) => {
				if (child === slottable) {
...
/* @__NO_SIDE_EFFECTS__ */
function createSlotClone$28(ownerName) {
	const SlotClone = import_react.forwardRef((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		if (import_react.isValidElement(children)) {
			const childrenRef = getElementRef$28(children);
			const props2 = mergeProps$28(slotProps, children.props);
			if (children.type !== import_react.Fragment) props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
			return import_react.cloneElement(children, props2);
		}
		return import_react.Children.count(children) > 1 ? import_react.Children.only(null) : null;
...
var SLOTTABLE_IDENTIFIER$28 = Symbol("radix.slottable");
...
function createSlot$27(ownerName) {
	const SlotClone = /* @__PURE__ */ createSlotClone$27(ownerName);
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		const childrenArray = import_react.Children.toArray(children);
		const slottable = childrenArray.find(isSlottable$27);
		if (slottable) {
			const newElement = slottable.props.children;
			const newChildren = childrenArray.map((child) => {
				if (child === slottable) {
...
/* @__NO_SIDE_EFFECTS__ */
function createSlotClone$27(ownerName) {
	const SlotClone = import_react.forwardRef((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		if (import_react.isValidElement(children)) {
			const childrenRef = getElementRef$27(children);
			const props2 = mergeProps$27(slotProps, children.props);
			if (children.type !== import_react.Fragment) props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
			return import_react.cloneElement(children, props2);
		}
		return import_react.Children.count(children) > 1 ? import_react.Children.only(null) : null;
...
var SLOTTABLE_IDENTIFIER$27 = Symbol("radix.slottable");
...
function createSlot$26(ownerName) {
	const SlotClone = /* @__PURE__ */ createSlotClone$26(ownerName);
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		const childrenArray = import_react.Children.toArray(children);
		const slottable = childrenArray.find(isSlottable$26);
		if (slottable) {
			const newElement = slottable.props.children;
			const newChildren = childrenArray.map((child) => {
				if (child === slottable) {
...
/* @__NO_SIDE_EFFECTS__ */
function createSlotClone$26(ownerName) {
	const SlotClone = import_react.forwardRef((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		if (import_react.isValidElement(children)) {
			const childrenRef = getElementRef$26(children);
			const props2 = mergeProps$26(slotProps, children.props);
			if (children.type !== import_react.Fragment) props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
			return import_react.cloneElement(children, props2);
		}
		return import_react.Children.count(children) > 1 ? import_react.Children.only(null) : null;
...
var SLOTTABLE_IDENTIFIER$26 = Symbol("radix.slottable");
...
function createSlot$25(ownerName) {
	const SlotClone = /* @__PURE__ */ createSlotClone$25(ownerName);
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		const childrenArray = import_react.Children.toArray(children);
		const slottable = childrenArray.find(isSlottable$25);
		if (slottable) {
			const newElement = slottable.props.children;
			const newChildren = childrenArray.map((child) => {
				if (child === slottable) {
...
/* @__NO_SIDE_EFFECTS__ */
function createSlotClone$25(ownerName) {
	const SlotClone = import_react.forwardRef((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		if (import_react.isValidElement(children)) {
			const childrenRef = getElementRef$25(children);
			const props2 = mergeProps$25(slotProps, children.props);
			if (children.type !== import_react.Fragment) props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
			return import_react.cloneElement(children, props2);
		}
		return import_react.Children.count(children) > 1 ? import_react.Children.only(null) : null;
...
var SLOTTABLE_IDENTIFIER$25 = Symbol("radix.slottable");
...
function createSlot$24(ownerName) {
	const SlotClone = /* @__PURE__ */ createSlotClone$24(ownerName);
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		const childrenArray = import_react.Children.toArray(children);
		const slottable = childrenArray.find(isSlottable$24);
		if (slottable) {
			const newElement = slottable.props.children;
			const newChildren = childrenArray.map((child) => {
				if (child === slottable) {
...
/* @__NO_SIDE_EFFECTS__ */
function createSlotClone$24(ownerName) {
	const SlotClone = import_react.forwardRef((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		if (import_react.isValidElement(children)) {
			const childrenRef = getElementRef$24(children);
			const props2 = mergeProps$24(slotProps, children.props);
			if (children.type !== import_react.Fragment) props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
			return import_react.cloneElement(children, props2);
		}
		return import_react.Children.count(children) > 1 ? import_react.Children.only(null) : null;
...
var SLOTTABLE_IDENTIFIER$24 = Symbol("radix.slottable");
...
function createSlot$23(ownerName) {
	const SlotClone = /* @__PURE__ */ createSlotClone$23(ownerName);
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		const childrenArray = import_react.Children.toArray(children);
		const slottable = childrenArray.find(isSlottable$23);
		if (slottable) {
			const newElement = slottable.props.children;
			const newChildren = childrenArray.map((child) => {
				if (child === slottable) {
...
/* @__NO_SIDE_EFFECTS__ */
function createSlotClone$23(ownerName) {
	const SlotClone = import_react.forwardRef((props, forwardedRef) => {
		const { children, ...slotProps } = props;
		if (import_react.isValidElement(children)) {
			const childrenRef = getElementRef$23(children);
			const props2 = mergeProps$23(slotProps, children.props);
			if (children.type !== import_react.Fragment) props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
			return import_react.cloneElement(children, props2);
		}
		return import_react.Children.count(children) > 1 ? import_react.Children.only(null) : null;
...
var SLOTTABLE_IDENTIFIER$23 = Symbol("radix.slottable");
...
var Slot$3 = /* @__PURE__ */ createSlot$24("MenuContent.ScrollLock");
...
var Slot$2 = /* @__PURE__ */ createSlot$14("PopoverContent.RemoveScroll");
...
var Radio = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(RadioProvider, {
		...
		checked,
		disabled,
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$11.button, {
			type: "button",
			role: "radio",
			"aria-checked": checked,
...
var ScrollAreaViewport = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("style", {
		...
		nonce
	}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$10.div, {
...
var Slot$1 = /* @__PURE__ */ createSlot$10("SelectContent.RemoveScroll");
...
var SelectBubbleInput = import_react.forwardRef(({ __scopeSelect, value, ...props }, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$9.select, {
		...props,
		style: {
			...VISUALLY_HIDDEN_STYLES,
			...props.style
...
var Slot = /* @__PURE__ */ createSlot$7("Slot");
/* @__NO_SIDE_EFFECTS__ */
...
var Switch = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SwitchProvider, {
		...
		checked,
		disabled,
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$6.button, {
			type: "button",
			role: "switch",
			"aria-checked": checked,
			"aria-required": required,
